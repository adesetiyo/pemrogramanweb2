...
<div class="container">
    <div class="table-responsive">
        <h3>Data Dosen Pengajar di Universitas Dharma AUB</h3>
        <hr>
        <div style="padding-bottom:20px">
        <a href="../adm_dosen/tambah_dosen.php" class="btn btn-primary" title="Tambah data dosen pengajar"><span class="glyphicon glyphicon-pencil"></span> Tambah Data Dosen</a>
        </div>
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="../adm_dosen/hapus_dosen.php?id=<?php echo $row["id_dosen"]; ?>" onclick="return confirm('Yakin MENGHAPUS Data Ini ?');" type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span> Hapus</a>
                </td>
            </tr>
        <?php
            }
