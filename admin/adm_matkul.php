...
<div class="container">
    <div class="table-responsive">
        <h3>Data Mata Kuliah Universitas Dharma AUB</h3>
        <hr>
        <div style="padding-bottom:20px">
        <a href="../adm_matkul/tambah_matkul.php" class="btn btn-primary" title="Tambah data mata kuliah"><span class="glyphicon glyphicon-pencil"></span> Tambah Data Matakuliah</a>
        </div>
